...
<body>
 ...
 <div id="menu">
   ...
   <input id="title" type="text" name="title" value="Chart title"/>
   <input id="statName" type="text" name="statName" value="StatHat stat code"/>
   <select id="chartStyle" name="chartStyle" required="true" title="Chart style">
    <option value="spark" default="true">Spark</option>
    <option value="mini">Mini</option>
    <option value="fill">Fill</option>
    <option value="fill_bar">Fill Bar</option>
   </select>
   <select id="chartSize" name="chartSize" required="true" title="Chart size">
   ...
   <select id="evt_color" title="Background color">
     <option value="#FFFFFF" default="true">White</option>
